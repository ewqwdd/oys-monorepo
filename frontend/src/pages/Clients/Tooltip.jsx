...
export default function Tooltip({search, setSearch, selected, setSelected, setOpen, messageApi}) {
  ...
  return (
    <Flex justify="space-between">
        <Input placeholder="Пошук" style={{ width: "50%" }} value={search} onChange={e => setSearch(e.target.value)} />
